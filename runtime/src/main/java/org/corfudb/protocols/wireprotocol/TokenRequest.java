...
public class TokenRequest implements ICorfuPayload<TokenRequest> {
    ...
    public static final byte QUERY_ALL_STREAMS = 5;
    ...
    public TokenRequest(Long numTokens, Set<UUID> streams) {
        ...
        } else if (numTokens == Integer.MAX_VALUE) {
            this.reqType = QUERY_ALL_STREAMS;
    ...
    public void doSerialize(ByteBuf buf) {
        ...
        if (reqType != TK_QUERY && reqType != QUERY_ALL_STREAMS) {
