...
public class SealIT extends AbstractIT{
    ...
    public void RuntimeWithWrongEpochGetUpdated() throws Exception {
        ...
        Long beforeAddress = cr2.getSequencerView().nextToken(Collections.emptyList(),1).getToken().getTokenValue();
         ...
         */
        Long afterAddress = cr2.getSequencerView().nextToken(Collections.emptyList(),1).getToken().getTokenValue();
